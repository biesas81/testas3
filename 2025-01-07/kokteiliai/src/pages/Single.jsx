    ...
    const formatIngredients = (value) => {
        ...
        for(let i = 1; i <= 15; i++) {
            if(value['strIngredient' + i]) {
                data.push(
                    <li key={i}>
                        <Link to={"/ingredient/" + value['strIngredient' + i]}>
                        <strong>{value['strIngredient' + i]}</strong> : {value['strMeasure' + i]}</Link>
                    </li>
            ...
            <div className="row">
                ...
                <div className="col-8">
                    ...
                    <div className="mb-4">
                        ...
                        <Link to={"/glass/" + data.strGlass} href="#">{data.strGlass}</Link>
                    </div>
                    <div className="mb-2">
